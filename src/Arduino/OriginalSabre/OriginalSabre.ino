...
#define LIGHTTIME   1000  // length of time the lights are kept on after a hit (ms)
#define BAUDRATE   57600  // baudrate of the serial debug interface

#define HITABUZZ HIGH
#define HITBBUZZ 100
...
#ifdef DEBUG
String electData = String("weaponA  : ") + weaponA  + "\n"
                            + "weaponB : "  + weaponB + "\n"
                            + "lameA  : "  + lameA  + "\n"
                            + "lameB  : "  + lameB   + "\n";
      Serial.println(electData); 
